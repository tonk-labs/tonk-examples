...
// Explicitly check if we're in production mode using Vite's environment variable
...
export function registerServiceWorker() {
  ...
  if ("serviceWorker" in navigator) {
    const registerSW = () => {
      // Use the correct path for the service worker generated by Vite PWA plugin
      const swUrl = import.meta.env.BASE_URL + "service-worker.js";

      navigator.serviceWorker
        .register(swUrl, { type: 'module' }) // Add type: 'module' for ES modules support
        .then((registration) => {
